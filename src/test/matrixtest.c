...
int TST_MatrixSetGet()
{
        ...
        assert(double_equal(matrix_get(m, 1, 1), 1000.50011f) == 1);
...
int TST_Matrix2Determinant()
{
        ...
        double data[] = {1.0f, 5.0f, -3.0f, 2.0f};
        m.matrix = data;
        assert(double_equal(matrix_2determinant(m), 17.0f) == 1);
...
int TST_MatrixMinor()
{
        ...
        assert(double_equal(matrix_minor(m, 1, 2), 6.0f) == 1);
        assert(double_equal(matrix_minor(m, 0, 0), -48.0f) == 1);
        assert(double_equal(matrix_minor(n, 2, 1), 12.0f) == 1);
        assert(double_equal(matrix_minor(n, 2, 2), -40.0f) == 1);
...
int TST_MatrixCofactor()
{
        ...
        assert(double_equal(matrix_minor(m, 0, 0), -12.0f) == 1);
        assert(double_equal(matrix_cofactor(m, 0, 0), -12.0f) == 1);
        assert(double_equal(matrix_cofactor(m, 1, 0), -25.0f) == 1);
...
int TST_MatrixDeterminant()
{
        ...
        assert(double_equal(matrix_cofactor(m3, 0, 0), 56.0f) == 1);
        assert(double_equal(matrix_cofactor(m3, 0, 1), 12.0f) == 1);
        assert(double_equal(matrix_cofactor(m3, 0, 2), -46.0f) == 1);
        assert(double_equal(matrix_determinant(m3), -196.0f) == 1);

        assert(double_equal(matrix_cofactor(m4, 0, 0), 690.0f) == 1);
        assert(double_equal(matrix_cofactor(m4, 0, 1), 447.0f) == 1);
        assert(double_equal(matrix_cofactor(m4, 0, 2), 210.0f) == 1);
        assert(double_equal(matrix_cofactor(m4, 0, 3), 51.0f) == 1);
        assert(double_equal(matrix_determinant(m4), -4071.0f) == 1);
...
int TST_MatrixChain()
{
        ...
        assert(matrix_equal(m, all_in_one) == 1);
