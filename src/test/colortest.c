...
int TST_ColorNewInt()
{
        ...
        assert(double_equal(col1.r, 0.7843147f));
        assert(double_equal(col1.g, 0.5882352f));
        assert(double_equal(col1.b, 0.3921568f));
        
        assert(double_equal(col2.r, 1.0f));
        assert(double_equal(col2.g, 0.5333333f));
        assert(double_equal(col2.b, 0.0f));
